...
<div>  
    ...
    <div class="container">  
        <div class="header">  
            <h1>Inicios de la F1</h1>  
        </div>  
        <div class="video-container">  
            <iframe width="560" height="315" src="https://www.youtube.com/embed/3rqSKgU-1Lo?si=NAU2tzcD0dZxjwQk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

        </div>  
    </div>   
    <a href="/formula1/formula1-1" data-sveltekit-reload="" data-sveltekit-preload-data="tap">  
