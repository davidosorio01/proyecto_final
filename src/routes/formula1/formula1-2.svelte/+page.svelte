<script lang="ts">
    ...
    const slidesContent: SlideContent[] = [
        {
            imgSrc: "../Cards img/CarreraF1.png",
        ...
        {
            imgSrc: "../Cards img/CampeonMundial.png",
        ...
        {
            imgSrc: "../Cards img/Constructores.png",
        ...
        {
            imgSrc: "../Cards img/AustriaGP.png",
