...
<div>  
            ...
            <nav>  
                ...
                <div class="nav-item" id="nav-item-1">  
                    <div class="progress-bar" id="progress-bar">  
                        <div class="rombo" id="rombo-1"><span class="numero">1</span></div>  
    ...
    <div class="container">  
        <div class="header">  
            <h1>Inicios del Baloncesto</h1>  
        </div>  
        <div class="video-container">  
            <iframe width="560" height="315" src="https://www.youtube.com/embed/2YvFP9vq9SM?si=EKenQscNB5u5qUCW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

        </div>  
    </div>   
    <a href="/baloncesto/baloncesto1" data-sveltekit-reload="" data-sveltekit-preload-data="tap">  
